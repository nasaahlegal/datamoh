...
def main():
    ...
    app.add_handler(MessageHandler(filters.Regex(r"^(إضافة سؤال جديد)$") & filters.User(ADMIN_TELEGRAM_ID), admin_add_question))
    app.add_handler(MessageHandler(filters.TEXT & filters.User(ADMIN_TELEGRAM_ID), admin_select_question))
